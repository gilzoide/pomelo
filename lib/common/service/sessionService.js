...
var kickLogger = require('pomelo-logger').getLogger('pomelo-kick', __filename);
...
SessionService.prototype.kick = function(uid, reason, cb) {
  ...
  kickLogger.debug("SessionService.kick uid: %s, reason: %s", uid, reason);
...
SessionService.prototype.kickBySessionId = function(sid, reason, cb) {
  ...
  kickLogger.debug("SessionService.kickBySessionId sid: %s, reason: %s", sid, reason);
